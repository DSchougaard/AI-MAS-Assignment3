...
%		Kasper
	...
	the single agent part shows that the performance is more or less equal when the looking at steps and time. the only major difference is the success rate one SAnull, where a livelock occurs 4/5 of the time, due to the nearer proximity of the goals.
