...
\section{Experiments and Results}
	...
	\begin{table}
		\begin{tabular}[t]{ l | r | L{1.2cm} | r | L{1.2cm} }
			...
			\textbf{Level}	&	\textbf{Steps}	&	\textbf{Time} \textit{(ms)}	&	\textbf{Steps}	&	\textbf{Time} \textit{(ms)}	\\
			\hline
