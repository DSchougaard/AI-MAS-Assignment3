...
%		
	...
	\subsection{Distances in the Map}
		For the Glory of the Sontarran Empire!
...
\section{Experiments and Results}
	...
	\subsection{Distance Maps}
		...
		In the current test set, the only case where we see an actual \emph{increase} in time is on \verb=SAGroup42F13=. However, we also see a great increase in the viability of the solution: $~29\%$. But seeing the gains that the FloydWarshall distance map resulted in, we've deemed it beneficial to always use it for pre-computation.
