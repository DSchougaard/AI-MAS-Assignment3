...
\section{Future Work}
	...
	\subsection{Does It Generalise?}
		...
		\subsubsection{Multi-Body NPC Route Finding in a Dynamic Environment}
			...
			What makes our solution excellent for this purpose, is that we employ online planning. The player, an outside agent, comes in a disrupts the agents view of the world, by completely eradicating the car infront, using aforementioned Gatling gun. Had we used offline planning, this would be a huge issue. However, with our approach a simple replanning -- or a round of conflict resolution -- suffices to figure out how the NPCs react.
